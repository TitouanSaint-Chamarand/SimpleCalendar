...
/** Barre de formatage (couleur du texte, surlignage) affichée en haut de la page. S’applique à la sélection courante dans une cellule. */
export default function FormattingToolbar() {
  return (
    <div className="flex flex-wrap items-center gap-3 py-3 px-4 mb-4 rounded-lg border border-border bg-muted/30">
